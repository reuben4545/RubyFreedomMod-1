...
public enum TFM_PlayerRank
{
    ...
    DARK("an " + ChatColor.BLUE + "Owner and founder" + ChatColor.AQUA + " and the " + ChatColor.DARK_PURPLE + "Co-Chief Developer", ChatColor.translateAlternateColorCodes('&', "&8[&4Owner &8+ &9Founder&8]&9")),
